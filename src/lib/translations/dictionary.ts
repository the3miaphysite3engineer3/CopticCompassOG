...
export const dictionaryMessages = defineMessages({
  en: {
    ...
    "entry.actions.shareDescription":
      "Share a compact preview of this entry with its gloss, or copy the text to post it anywhere.",
    ...
    "entry.actions.reportDescription":
      "If you spot a typo, unclear meaning, or incorrect grouping, send a short note so it can be reviewed.",
    ...
    "entry.actions.reason.relation": "Wrong grouping",
    ...
    "analytics.filterEtymologyUnknown": "Unknown Only",
    ...
    "analytics.unknownEtymology": "Unknown Etymology",
  ...
  nl: {
    ...
    "entry.compoundOf": "Samenstelling van",
    ...
    "entry.actions.shareDescription":
      "Deel een compact voorbeeld van dit lemma met vertaling, of kopieer de tekst om die elders te plaatsen.",
    ...
    "entry.actions.reportDescription":
      "Ziet u een typefout, onduidelijke betekenis of foute groepering, stuur dan een korte toelichting zodat dit nagekeken kan worden.",
    ...
    "entry.actions.reason.relation": "Foute groepering",
    ...
    "analytics.filterEtymologyUnknown": "Alleen onbekend",
    ...
    "analytics.unknownEtymology": "Onbekende etymologie",
